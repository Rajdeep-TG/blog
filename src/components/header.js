      ...
      <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start">
        <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
          <div className="flex items-center justify-between w-full md:w-auto">
            <Link to="/" aria-label="Rajdeep.ml Blog">
              <img src="https://res.cloudinary.com/zype/image/upload/CodeWithR/fullLogo" alt="Full Logo" className="hidden sm:block h-10" />
              <img src="https://res.cloudinary.com/zype/image/upload/CodeWithR/logo" alt="Short Logo" className="h-10 sm:hidden" />
            </Link>
          ...
          <div className="rounded-lg shadow-md">
            ...
            >
              <div className="px-2 pt-8 flex items-center justify-between">
                <div>
                  <img src="https://res.cloudinary.com/zype/image/upload/CodeWithR/logo" alt="Short Logo" className="h-10" />
                </div>
                <div className="-mr-2">
                  <button
                    onClick={() => toggleMobileNavOpen()}
